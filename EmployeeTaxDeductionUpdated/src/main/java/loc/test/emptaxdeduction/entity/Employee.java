package loc.test.emptaxdeduction.entity;
...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", employeeId=" + employeeId + ", firstName=" + firstName + ", lastName="
				+ lastName + ", email=" + email + ", phoneNumbers=" + phoneNumbers + ", doj=" + doj + ", monthlySalary="
				+ monthlySalary + ", salaryCreditDate=" + salaryCreditDate + "]";
	}
